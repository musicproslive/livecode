						...
						<div class="grid-body no-border">
							<div class="row">
							   <ul class="nav nav-tabs" id="tab-01">
									...
									<!--<li id="2"><a href="#billing">Billing</a></li>-->
								...
								<div class="tab-content" id="tab-content">
									    ...
									    <div class="col-md-6">
											 <div class="grid simple">
												<div class="grid-title no-border">
													...
													<div class="row">
													     <div class="form-group">
														    <label class="col-xs-8 form-label">How did you find out about TalkMusik?</label>
                                                            <div class="col-xs-8">
															   <?php if($user_det[0]['refer_by']!=""&&$user_det[0]['refer_by']!="Other"){
																   echo $user_det[0]['refer_by'];
																   
															   }
															   else
															   {
																    echo $user_det[0]['refer_by_text'];
															   }?>
															</div>
														 </div>	
													</div>	 
												...
												<div class="grid-title no-border">
									                ...
									                <div class="row">
													     <div class="form-group">
                                                            ...
                                                            <div class="col-xs-8">
															   <textarea id="txtAboutMe" class="form-control" name="txtAboutMe"><?php echo $user_det[0]['about_me'];?></textarea>
															</div>															
														 </div>	
												    </div>
													<div class="row">
									 ...
									 <div class="tab-pane " id="lessons">
										<div class="col-md-12">
										  <ul class="nav nav-tabs" id="tab-01">
											 <!--<li  id="1" onclick="javascript:getLessons(1,1);"><a href="#scheduled_1">Scheduled</a></li>-->
											<li class="active" id="2" onclick="javascript:getLessons(1,1);"><a href="#booked_2">Booked</a></li>
											<li id="3" onclick="javascript:getLessons(1,3);"><a href="#completed_3">Completed</a></li>
											<li id="4" onclick="javascript:getLessons(1,2);"><a href="#cancelled_4">Cancelled</a></li>
											<li id="5" onclick="javascript:getLessons(1,4);"><a href="#expired_5">Expired</a></li>
										  </ul>
									 ...
									 <div class="tab-pane " id="welcome">
									        <div class="form-group">
													<p for="Instruments" class=" form-label">To add a video to your profile, upload a video on YouTube. Afterwards, go to the video link and copy and paste the last part of the link in the box, as shown below. The video will appear on your TalkMusik profile page.</p>
														<br>
														<img src="../liveroom/images/YouTubeInstructions.jpg">
											</div>
											<div class="form-group">
													...
													<div class="control-group control-group  checkboxGroup advanced-agt panel panel-default">
															...
															<div class="controls">
																...
																<tbody>
															       ...
															       <?php 
																       foreach($all_ins as $all_ins){?>
																	     <tr style="border-top: solid 1px #ddd;">
																          <td><?php echo $all_ins['name']?></td>
																		   <td>	
																				<input type="checkbox" name="levs[]" id="" class="" value="<?php echo $all_ins['instrument_id']?> " <?php if (in_array($all_ins['instrument_id'],$inst_list_arr)) echo 'checked="checked"' ?> />
																			</td>
																	...
																	<?php foreach($advance_approved_levels as $advance_levels){?>
																		<tr style="border-top: solid 1px #ddd;">
																		   ...
																		   <?php } else{?>
																			...
																			<a href="<?php echo '../liveroom/Uploads/certificates/'.$advance_levels['filename']?>"target="_blank"><i class="fa fa-file-text-o" title="Click here to view video(s)" alt="Video"></i></a>
																		   <?php } else{?>
																			N/A
																			<?php }?></td>
									 ...
									 <div class="tab-pane " id="documents">
										...
										<div class="col-md-12">
											<div class="col-md-6">
												...
												<h4>W-9 Form</h4>
												<iframe src="https://docs.google.com/gview?url=http://54.172.27.208/classroom/Uploads/W9/<?php echo $docs[0]['w9form_name']?>&embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>
												
											</div>
											<div class="col-md-6">
												<h4>Getting Paid</h4>
												<iframe src="https://docs.google.com/gview?url=http://54.172.27.208/classroom/Uploads/directdepo/<?php echo $docs[0]['dfform_name']?>&embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>
											</div>
										...
										<div class="col-md-12">
										    <div class="col-md-6">
												<h4>Resume</h4>
												<iframe src="https://docs.google.com/gview?url=http://54.172.27.208/classroom/files/resumes/<?php echo $odata[0]['value']?>&embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>
											</div>
										      <br/>
...
var scheduled_lesson =  $('#lessscheduled').DataTable( {
		...
		"ajax":"stdCoursesbooked.php?enrl_status=1",
...
var booked_lesson =  $('#lessbooked').DataTable( {
		...
		"responsive":true,
		"oLanguage": {
			"sZeroRecords": "You currently don't have any meetings scheduled. To schedule a meeting, choose an professional above."
			},
		"ajax":"stdCoursesbooked.php?enrl_status=2",
	...
	var completed_lesson =  $('#lesscompleted').DataTable( {
		...
		"ajax":"stdCoursesbooked.php?enrl_status=3",
		columns: [  
					{ "defaultContent":""}, 
					 { "defaultContent":""}, 
					 { "defaultContent":""}, 
	...
	var cancelled_lesson =  $('#lesscancelled').DataTable( {
		...
		"ajax":"stdCoursesbooked.php?enrl_status=4",
		columns: [  
	...
	var expired_lesson =  $('#lessexpired').DataTable( {
		...
		"ajax":"stdCoursesbooked.php?enrl_status=5",
		columns: [  
...
<script type="text/javascript">
   function getLessons(page,enrl_status)
			...
			if(enrl_status==1)
			{
				booked_lesson.ajax.url( 'stdCoursesbooked.php?enrl_status=1&user_id='+user_id+"&time_format_id="+time_format_id+"&user_code="+user_code).load();
				
			}
			else if(enrl_status==2)
			{
				
				cancelled_lesson.ajax.url( 'stdCoursesbooked.php?enrl_status=2&user_id='+user_id+"&time_format_id="+time_format_id+"&user_code="+user_code ).load();
				
			}
			else if(enrl_status==3)
			{
				completed_lesson.ajax.url( 'stdCoursesbooked.php?enrl_status=3&user_id='+user_id+"&time_format_id="+time_format_id+"&user_code="+user_code ).load();
			}
			else if(enrl_status==4)
			{
				expired_lesson.ajax.url( 'stdCoursesbooked.php?enrl_status=4&user_id='+user_id+"&time_format_id="+time_format_id+"&user_code="+user_code ).load();
			}
