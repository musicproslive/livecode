...
*************** ***********************************************************************/
class approvedContent extends modelclass
	{
		public function approvedContentListing()
			{					
				$alb	= 	new albumlist();
				$allData = $alb -> getApprovedImages();
				return 	$allData;				
			}	
		
		public function approvedContentApporve(){
			if(!empty($_POST)){
				$alb	= 	new albumlist();
			...
			$this->redirectAction($err,"Listing","approvedContent.php");	
		}
		
		public function approvedContentDelete(){
				//print_r ($_POST['imgId']);
