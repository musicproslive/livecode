	...
	Croppic.prototype = {
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.destroy();
				alert("News picture uploaded successfully");
				$("#news_image").val(response.image_name);
				
				$("#current_pp").attr('src',response.url);
				
				$(".profile-wrapper img").attr('src',response.url);
				$(".profile-pic img").attr('src',response.url);
